...
$\eta_i = a_{ij} + x_{ij} b_j$. The unknown $b$ is assigned a
...
normal density $N(b; \mu, S)$. See the [Overleaf document][overleaf]
for a more detailed description of the model and variational
approximation.
